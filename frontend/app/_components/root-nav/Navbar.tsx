...
export default function Navbar() {
  ...
  return (
    <header className="relative navbar p-3 bg-base-300">
      <nav className="navbar-start">
        ...
        {navMenuOpen && (
          <ul
            ...
            className="absolute left-3 -bottom-3 translate-y-full menu menu-md bg-base-300 font-medium z-[1] w-60 p-2 flex flex-col gap-2">
            <li>
              <Link href="/">Home</Link>
            </li>
            <li>
